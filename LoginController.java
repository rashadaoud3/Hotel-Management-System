...
public class LoginController implements Initializable {
    ...
    public void handleLoginAction(javafx.event.ActionEvent actionEvent) throws IOException {
        ...
        // select all records from the "staff" table, where name and pass. match the input values
        ...
        try {
            ...
            int count = 0;
            while (rs.next()) {// return true if there at least one row in the list
    ...
    private void OptionPane(String message, String title) {
        ...
        // style=utility, which provides a simple dialog box without a title bar
