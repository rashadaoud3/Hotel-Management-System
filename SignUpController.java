...
public class SignUpController implements Initializable {
    ...
    public void handleSignupAction(javafx.event.ActionEvent actionEvent) {
        ...
        // Ensures that none of the retrieved values are null.
        ...
        // Alert if any of the options are NULL
        if (name_text.equals("") || username_text.equals("") || password_text.equals("") || gender_text.equals("")
            ...
            if (isUsernameExists(username_text)) {
                OptionPane("Username already exists. Please choose a different username.", "Error Message");
            } else {
                String insert = "INSERT INTO staff (name, username, password, gender, securityQuestion, answer, address)"
                        + "VALUES (?, ?, ?, ?, ?, ?, ?)";
